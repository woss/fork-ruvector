...
export const ConversationSummarySkill: Skill = {
...
async function* summarizeExecutor(
  context: SkillExecutionContext,
  params: Record<string, unknown>
): AsyncGenerator<SkillStep, SkillExecutionResult, void> {
  const text = params.text as string;
  const style = (params.style as string) || 'bullet';
...
async function* conversationSummaryExecutor(
  context: SkillExecutionContext,
  params: Record<string, unknown>
): AsyncGenerator<SkillStep, SkillExecutionResult, void> {
...
export const SummarizeSkills = [SummarizeSkill, ConversationSummarySkill];
