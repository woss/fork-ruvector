...
exports.AIDefenceGuard = exports.DEFAULT_AIDEFENCE_CONFIG = exports.AIDefenceConfigSchema = void 0;
exports.createAIDefenceMiddleware = createAIDefenceMiddleware;
exports.createAIDefenceGuard = createAIDefenceGuard;
 ...
 */
exports.AIDefenceConfigSchema = zod_1.z.object({
    detectPromptInjection: zod_1.z.boolean().default(true),
    detectJailbreak: zod_1.z.boolean().default(true),
    detectPII: zod_1.z.boolean().default(true),
    enableBehavioralAnalysis: zod_1.z.boolean().default(false),
    enablePolicyVerification: zod_1.z.boolean().default(false),
    blockThreshold: zod_1.z.enum(['none', 'low', 'medium', 'high', 'critical']).default('medium'),
    customPatterns: zod_1.z.array(zod_1.z.string()).optional(),
    allowedDomains: zod_1.z.array(zod_1.z.string()).optional(),
    maxInputLength: zod_1.z.number().positive().default(100000),
    enableAuditLog: zod_1.z.boolean().default(true),
    serverUrl: zod_1.z.string().url().optional(),
});
// ============================================================================
// Default Configuration
// ============================================================================
exports.DEFAULT_AIDEFENCE_CONFIG = {
...
class AIDefenceGuard {
    constructor(config = {}) {
        ...
        this.config = { ...exports.DEFAULT_AIDEFENCE_CONFIG, ...config };
    ...
    async analyzeBehavior(input, userId) {
        const threats = [];
...
exports.AIDefenceGuard = AIDefenceGuard;
// ============================================================================
// Middleware Factory
// ============================================================================
/**
 ...
 */
function createAIDefenceMiddleware(config) {
    ...
    return {
         ...
         */
        async validateOutput(output, originalInput) {
 ...
 */
function createAIDefenceGuard(config) {
 ...
 */
function createPermissiveConfig() {
    return {
        ...exports.DEFAULT_AIDEFENCE_CONFIG,
        detectPromptInjection: true,
        detectJailbreak: true,
...
exports.default = AIDefenceGuard;
//# sourceMappingURL=AIDefenceGuard.js.map